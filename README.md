...
Desktop: | Mobile
:-------:|:-------:
<img src="https://i.ibb.co/Mpsh9v5/user-desktop.png" alt="user-desktop" width="500"> | <img src="https://i.ibb.co/cgZyMPM/user-mobile.png" alt="user-mobile" width="250" border="0">
